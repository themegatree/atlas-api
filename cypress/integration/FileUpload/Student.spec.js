        ...
        cy.fixture('/csv-files/Students/failingmock.csv').then(fileContent => {
          ...
          cy
            ...
            .should(res => {
              ...
              expect(parsedData.response[1]).to.eq('You have entered an invalid or not yet included gender: Test on line 1' )
              expect(parsedData.response[2]).to.eq('You have entered an invalid or not yet included gender: Test on line 1' )
              expect(parsedData.response[0]).to.eq('You have entered an invalid or not yet included gender: Test on line 1' )
            })
        })
      })
